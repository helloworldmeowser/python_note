"""The following notes are from module three Google IT Automation with Python through Coursera."""
#While Loop, Infinite Loop, Break Statement, Pass Statemend Reminder
